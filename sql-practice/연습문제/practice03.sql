...
select concat(e.first_name, ' ', e.last_name) as '이름', d.dept_name, t.title
...
select concat(e.first_name, ' ', e.last_name) as '이름', t.title, s.salary
...
select d.dept_name, avg(s.salary)
  from departments d, dept_manager dm, salaries s
